import { Controller, Get, Post, Body, UseGuards, Request, Req, Res, HttpCode, HttpStatus } from "@nestjs/common";
...
export class authController {
    ...
    @ApiOperation({
        ...
        description: 'Redireciona o usuário para o fluxo de autenticação do GitHub.',
    })
    @ApiResponse({
        status: 302,
    ...
    @ApiOperation({
        ...
        description: 'Recebe os dados do GitHub, gera um token JWT e redireciona para o front-end.',
    })
    @ApiResponse({
        status: 302,
