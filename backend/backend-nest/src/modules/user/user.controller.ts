import { Body, Controller, Get, Post, Patch, Req, UseGuards, UnauthorizedException, BadRequestException } from '@nestjs/common';
...
export class UserController {
    ...
    const userIdRaw = req.user?.sub ?? req.user?.id ?? req.user?.userId;
        ...
        const data: any = {};
        if (typeof body.usernameGit !== 'undefined') data.usernameGit = body.usernameGit;
        ...
        const { password, ...userWithoutPassword } = update as any;
